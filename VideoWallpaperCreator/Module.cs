...
namespace VideoWallpaperCreator
{
    class Module
    {
        ...
        public static string ApplicationName = "Video Wallpaper Creator";
        ...
        public static string DownloadURL = "http://softpcapps.com/d/VideoWallpaperCreator/";
        public static string HelpURL = "http://softpcapps.com/video-wallpaper-creator/how-to-use.php";
        public static string ProductWebpageURL = "http://softpcapps.com/video-wallpaper-creator/";
        public static string BuyURL = "http://softpcapps.com/store/buy-video-wallpaper-creator.php";        
        public static string VersionURL = "http://cssspritestool.com/versions/video-wallpaper-creator.txt";        

        public static string TipText = "Great application for Joining Videos !";
        ...
        public static string OpenFilesFilter = 
            ...
            "Webm Files (*.webm)|*.webm|Other Video Files (*.asf;*.mts;*.m2p;*.m2ts;*.m2v;*.m4v;*.mp2;*.ogm;*.ogv;*.ts)|*.asf;"+
        ...
        public static string AcceptableMediaInputPattern = "*.avi;*.mp4;*.mpeg;*.mpg;*.mov;*.mkv;*.flv;*.wmv;*.3gp;*.vob;*.swf;*.3g2;*.asf;*.m2p;*.mts;*.m2ts;*.m2v;*.m4v;*.mp2;*.ogm;*.ogv;*.qt;*.rm;*.rmvb;*.ts";
        
        public static FormatSetting SelectedFormatSetting = new FormatSetting();

        public static string AppDataDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Video Wallpaper Creator\\";
...
//        public static string DialogFilesFilter = "PDF Files (*.pdf)|*.pdf|JPEG Images (*.jpg)|*.jpg;*.jpeg|GIF Images (*.gif)|*.gif" +
  //      "|Bitmap Images (*.bmp)|*.bmp|PNG Images (*.png)|*.png|All Files (*.*)|*.*";
        ...
        public static void CheckVersion(bool onstart)
        {
            try
            {
                string str = DownloadPage("http://softpcapps.com/versions.txt");
